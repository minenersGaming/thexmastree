  ...
  return (
    <>
      <div className=" z-[100] flex w-full justify-center">
        ...
        <div
          onClick={UpdateBar}
          className="transition-all bottom-[40px] absolute grad-commonred z-[50] text-white font-bold p-3 text-center rounded-full"
          style={{
        ...
        >
          <div className="flex flex-row justify-evenly">
            <p>
              {!isExtend ? "Copy Link" : "https://xmas.tucm.cc/t/ilovetucmc"}
            </p>{" "}
            {/** FIX THE LINK LATER */}
