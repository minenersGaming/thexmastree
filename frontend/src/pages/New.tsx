...
const New = () => {
    ...
    return <><div id="common-bg" className="fixed flex flex-col justify-center items-center bottom" style={{overflow: "hidden", width: "auto"}}>
      
      <Background var={bgIndex} />

      <div draggable="false" className="flex justify-center fixed z-20 w-[100vw] max-w-[320px] bottom-[20vh]">
