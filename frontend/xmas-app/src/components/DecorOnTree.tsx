...
const BOXTOP = ["-270px","-220px","-90px","150px","200px","-60px","350px","310px","200px"]
const BOXLEFT = ["-230px","250px","-200px","-240px","-10px","270px","-300px","90px","400px"]
const BOXALIGN = ["right","left","right","right","right","left","left","left","left"]
...
const DecorOnTree = ( {position, type, display, sender, message }: DecorOnTreeProps ) => {
    if (display) {
        ...
        <img src={`/src/assets/onTree/${NAME[type]}.svg`} className="absolute w-[55px] pointer-events-none z-[55]" style={{
          ...
          <div className="text-[16px] absolute z-[70] text-center grad-commonred p-2 rounded-full text-white font-bold font-inter font-noto-sans-thai shadow-2xl text-nowrap max-w-[150px]  overflow-clip"  style={{
